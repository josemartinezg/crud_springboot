...
INSERT INTO alquiler (ID, ESTADO_ID, FECHA_ALQUILER, FECHA_DEVOLUCION_REAL, FECHA_DEVOLUCION_ESPERADA, CLIENTE_ID)
    VALUES (1, 4, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 1);

INSERT INTO EQUIPO_LISTADEALQUILERES (LISTADEEQUIPOSRENTADOS_ID, LISTADEALQUILERES_ID) values (1,1);